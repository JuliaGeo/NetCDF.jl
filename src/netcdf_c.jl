...
const NC_FILL_BYTE = - 127
const NC_FILL_CHAR = 0
const NC_FILL_SHORT = - 32767
const NC_FILL_INT = - Int64(2147483647)
const NC_FILL_FLOAT = Float32(9.9692099683868690e+36)
const NC_FILL_DOUBLE = 9.9692099683868690e+36
const NC_FILL_UBYTE = 255
const NC_FILL_USHORT = 65535
const NC_FILL_UINT = UInt64(4294967295)
...
const NC_MIN_BYTE = - NC_MAX_BYTE - 1

const NC_MAX_CHAR = 255
const NC_MAX_SHORT = 32767

const NC_MIN_SHORT = - NC_MAX_SHORT - 1

const NC_MAX_INT = 2147483647

const NC_MIN_INT = - NC_MAX_INT - 1

const NC_MAX_FLOAT = Float32(3.402823466e38)

const NC_MIN_FLOAT = - NC_MAX_FLOAT

const NC_MAX_DOUBLE = 1.7976931348623157e308

const NC_MIN_DOUBLE = - NC_MAX_DOUBLE

const NC_MAX_UBYTE = NC_MAX_CHAR
const NC_MAX_USHORT = UInt32(65535)
const NC_MAX_UINT = UInt32(4294967295)

const NC_MAX_INT64 = Int64(9223372036854775807)
const NC_MIN_INT64 = - Int64(9223372036854775807) - 1
const NC_MAX_UINT64 = UInt64(18446744073709551615)
