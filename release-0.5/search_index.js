...

{
    ...
    "category": "section",
    "text": "The most common task is probably to just read a NetCDF file into memory. This is done withncread(filename, varname)This reads the whole variable into memory and returns it as a Julia array. To read only a slice of a NetCDF file, there are optional start and count keyword arguments, where on can specify the starting index and count along each dimension."
},
...

{
    ...
    "page": "Short note on reading and writing NC_CHAR and NC_STRING variables",
    "title": "Short note on reading and writing NC_CHAR and NC_STRING variables",
    "category": "page",
    "text": ""
},

{
    "location": "strings.html#Short-note-on-reading-and-writing-NC_CHAR-and-NC_STRING-variables-1",
    "page": "Short note on reading and writing NC_CHAR and NC_STRING variables",
    "title": "Short note on reading and writing NC_CHAR and NC_STRING variables",
    "category": "section",
